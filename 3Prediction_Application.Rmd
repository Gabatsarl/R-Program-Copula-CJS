...
##--------------------------------------------------------#
#
#           Prediction with 2-exchangeable copula model
#
#---------------------------------------------------------#
...
library(copula) ; library(VineCopula) ; library(fitdistrplus)  ; library(GoFKernel) ; library(statmod) ; library(ggplot2) ; library(lmeresampler)
...
xx<-optim(xx$par,fn=Likelihood_2exchangeable,data=data.sch,hessian = TRUE)
...
# school 1
Pred_School1<-Prediction_2_exchangeable(i=1,K=10,data=data.sch,alpha1=alpha1,beta1=beta1,alpha2=alpha2,beta2=beta2,lambda=lambda,delta2=delta2,
...
# school 30
Pred_School1<-Prediction_2_exchangeable(i=30,K=10,data=data.sch,alpha1=alpha1,beta1=beta1,alpha2=alpha2,beta2=beta2,lambda=lambda,delta2=delta2,
                                        kappa1=kappa1,kappa2=kappa2,delta3=delta3)
...
Resid_exch<-residual_exchangeable_model(K=10,data=data.sch,alpha1=alpha1,beta1=beta1, alpha2=alpha2,beta2=beta2,lambda=lambda,delta2=delta2,
                                        kappa1=kappa1,kappa2=kappa2,delta3=delta3)

# residual 
resid_CM<-Resid_exch ; mean(resid_CM^2) ; IQR(resid_CM)
